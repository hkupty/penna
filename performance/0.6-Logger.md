...
This is a comparison between penna and logback (both `logback-contrib` and `logstash-logback-encoder`) for json logs, for penna 0.6 @ commit `ca142e8a9d9dbdf13b89db4f2de001aaedb1c3f6`
